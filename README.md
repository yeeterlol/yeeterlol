...
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; left: 50dvi; top: 50dvb; width: 80dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; height: 100px; width: 1000px; animation: 0.25s linear both alternate infinite shrink-x; background-image: url('https://github.com/yeeterlol/yeeterlol/blob/main/toro%20the%20silly%20cat.png?raw=true');]{x0000}$}
```
...
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; left: 50dvi; top: 75dvb; width: 80dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; height: 200px; width: 1000px; animation: 0.25s linear both alternate infinite shrink-x; background-image: url('https://github.com/yeeterlol/yeeterlol/blob/main/suzuki.png?raw=true');]{x0000}$}
```

```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.5; background: url('https://raw.githubusercontent.com/yeeterlol/yeeterlol/main/GO8o0XXWIAAqqoD.jpg');]{x0000}$}
```
